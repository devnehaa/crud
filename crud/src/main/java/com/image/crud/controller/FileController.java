package com.image.crud.controller;

import java.util.List;
import java.util.stream.Collectors;

import com.image.crud.dto.ResponseFile;
import com.image.crud.dto.ResponseMessage;
import com.image.crud.entity.FileDB;
import com.image.crud.service.FileStorageService;
...
public class FileController {
  ...
  public ResponseEntity<byte[]> getFileById(@PathVariable String id) {
    ...
    if (fileDB != null) {
      ...
      headers.setContentLength(fileDB.getData().length);
